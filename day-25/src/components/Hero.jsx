...
const Hero = () => {
  return (
    <div className="hero-container flex px-4 flex-col items-center gap-5 py-10 bg-sky-blue-50 md:gap-8 md:py-24">
      ...
      <div className="flex text-[44px] font-bold justify-center text-dark-blue-200">
        <p className="text-center tracking-[0.02rem] leading-[2.8rem] ">
          Linked
          <FontAwesomeIcon
      ...
      <div className="flex flex-col gap-3 items-center md:flex-row md:gap-5 mb-6 " >
      ...
      <p className="text-[14px] text-dark-blue-100 hidden md:block" >No credit card required . GDPR Complaint . ISO27001 Certified</p>
    </div>
  );
};
