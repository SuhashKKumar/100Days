...
const CodeSnippet = ({ code, language }) => {
    ...
    return (
        <div className="max-w-3xl mx-auto bg-code p-6 rounded-lg shadow-md flex flex-col gap-4 mb-[3rem] md:pb-[5rem]">
            ...
            <div className="btn-container flex gap-2">
                ...
                <button
                    className="bg-yellow-200 text-yellow-600 py-2 px-4 rounded"
                    onClick={demoHandler}
                    >
                    Live demo
                </button>
