...
const DesignSpotlightNav = () => {
    ...
    return (
        <div className="hidden md:inline-block " >
            ...
            <div
                ref={navItemRef}
                className={`${showNavItems ? " absolute bg-white shadow-xl px-10 py-4 rounded-xl flex items-start justify-between gap-10" : "hidden"}`}
            >
                                            ...
                                            ({ id, label, link }) => {
                                                return (
                                                    <a
                                                        href={link}
                                                        key={id}
                                                        className="font-light text-sm mx-1 p-2 py-1 rounded hover:bg-gray-100"
                                                    >
                                                        {label}
                                                    </a>
                                                );
